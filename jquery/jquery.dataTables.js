...
(/** @lends <global> */function( $ ) {
	 ...
	 *
	 */
	_fnCamelToHungarian ( src, user, force )
	{
	...
	DataTable.ext = _ext = {
		...
		pager: {
			//TODO 这个地方是自己加的分页模式
			bibenet_numbers : function(page, pages){
				return [ 'first', 'previous', _bibenet_numbers(page, pages, 5), 'next', 'last' ];
			}
		},
	...
	//TODO 这个地方是自定义的分页样式,count为奇数
	function _bibenet_numbers(page, pages, count){
		var numbers = [];
		var mid = Math.floor(count / 2);//3
//		if(page > mid){
